<template>
  <main class="w-full min-h-screen bg-yellow-50 h-full">
    ...
    <!-- Gallery Section -->
    <section class="container mx-auto px-4 pb-16 bg-yellow-50">
      <div class="text-center">

        <h1 class="text-[24px] md:text-4xl font-semibold mb-6 font-['Times_New_Roman']">Picture</h1>
        <p class="text-[22px] text-gray-700 font-['Times_New_Roman']">Kita Akan Selalu</p>
        <p class="text-[22px] text-gray-700 font-['Times_New_Roman'] mb-4">Bersama</p>
      </div>
