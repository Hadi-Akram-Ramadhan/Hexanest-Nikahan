<template>
  <div class="w-full min-h-full bg-yellow-50 h-full">
    <!-- Gallery Section -->
    <section class="container mx-auto px-4 py-12 md:pb-16 bg-yellow-50 w-full h-full min-h-screen">
      <div class="text-center mb-8">
        <h1 class="text-2xl sm:text-3xl md:text-4xl font-semibold mb-4 font-['Times_New_Roman'] text-gray-700">Picture</h1>
